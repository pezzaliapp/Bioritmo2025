...
function downloadPDF() {
  try {
    // Distrutturazione di jsPDF dal namespace UMD
    ...
    // Spezziamo l'analisi su più righe se necessario
    const analysis = generateAnalysis(biorhythmResults);
    const splittedText = pdf.splitTextToSize(analysis, 180);
    pdf.text(splittedText, 10, 80);
